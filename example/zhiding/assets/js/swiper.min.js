                ...
                return (
                    a.WebKitCSSMatrix
                        ...
                        : (i = (r =
                              ...
                              .split(',')),
                    'x' === t &&
                        (s = a.WebKitCSSMatrix ? r.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
                    'y' === t &&
                        (s = a.WebKitCSSMatrix ? r.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
                    s || 0
                );
            },
    ...
    var u = {
        ...
        updateSlides: function () {
            ...
            if (void 0 !== i) {
                ...
                for (
                    var C, M = e.slidesPerColumn, P = T / M, z = Math.floor(h / e.slidesPerColumn), k = 0;
                    k < h;
                    k += 1
                ) {
                    S = 0;
                        ...
                        l[k] && (l[k].swiperSlideSize = S),
                            ...
                            e.centeredSlides
                                ? ((y = y + S / 2 + x / 2 + w),
                                  ...
                                  c.push(y))
                                : (e.roundLengths && (y = Math.floor(y)),
                                  (E - Math.min(this.params.slidesPerGroupSkip, E)) % this.params.slidesPerGroup == 0 &&
                                      p.push(y),
                                  c.push(y),
                                  (y = y + S + w)),
                ...
                if (!e.centeredSlides) {
                    ...
                    (p = C),
                        Math.floor(this.virtualSize - i) - Math.floor(p[p.length - 1]) > 1 &&
                            p.push(this.virtualSize - i);
                }
                if (
                    (0 === p.length && (p = [0]),
                    0 !== e.spaceBetween &&
                                    ...
                                    ? ((m = !1),
                                      s.resistance &&
                                          (t.currentTranslate =
                                              this.minTranslate() -
                                              1 +
                                              Math.pow(-this.minTranslate() + t.startTranslate + f, g)))
                                    : f < 0 &&
                                      ...
                                      s.resistance &&
                                          (t.currentTranslate =
                                              this.maxTranslate() +
                                              1 -
                                              Math.pow(this.maxTranslate() - t.startTranslate - f, g))),
    ...
    var W = {
        ...
        te = {
            update: function (e) {
                ...
                if (
                    (d.extend(t.virtual, { from: x, to: E, offset: T, slidesGrid: t.slidesGrid }),
                    p === x && c === E && !e)
                )
        ...
        le = {
            ...
            init: function () {
                if (this.params.scrollbar.el) {
                    ...
                    0 === a.length &&
                        ((a = n('<div class="' + this.params.scrollbar.dragClass + '"></div>')), s.append(a)),
            ...
            setTranslate: function () {
                ...
                for (var u = 0; u < s.length; u += 1) {
                    ...
                    if (
                        ...
                        0 === T.length &&
                            ((T = n('<div class="swiper-slide-shadow-' + (h ? 'left' : 'top') + '"></div>')),
                            v.append(T)),
                            0 === S.length &&
                                ((S = n('<div class="swiper-slide-shadow-' + (h ? 'right' : 'bottom') + '"></div>')),
                                v.append(S)),
            ...
            setTranslate: function () {
                for (
                    ...
                    if ((f.transform(C), (f[0].style.zIndex = 1 - Math.abs(Math.round(g))), r.slideShadows)) {
                        ...
                        0 === M.length &&
                            ((M = n('<div class="swiper-slide-shadow-' + (o ? 'left' : 'top') + '"></div>')),
                            f.append(M)),
                            0 === P.length &&
                                ((P = n('<div class="swiper-slide-shadow-' + (o ? 'right' : 'bottom') + '"></div>')),
                                f.append(P)),
